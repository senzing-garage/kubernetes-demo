...
Using `minikube`, bring up a Senzing stack on Kubernetes using Helm, RabbitMQ, and a SQLite database cluster.
...
1. [Demonstrate](#demonstrate)
    ...
    1. [View data](#view-data)
        ...
        1. [View SQLite database](#view-sqlite-database)
...
1. Install chart.
   Example:
    ...
    helm install \
      ...
      --namespace ${DEMO_NAMESPACE} \
      --values ${GIT_REPOSITORY_DIR}/helm-values/senzing-console-sqlite-cluster.yaml
    ```
...
1. Install chart.
   Example:
    ...
    ```console
    helm install \
      ${DEMO_PREFIX}-coleifer-sqlite-web-libfeat \
      senzing/coleifer-sqlite-web \
      --namespace ${DEMO_NAMESPACE} \
...
1. Install chart.
   Example:
    ...
    ```console
    helm install \
      ${DEMO_PREFIX}-coleifer-sqlite-web-res \
      senzing/coleifer-sqlite-web \
      --namespace ${DEMO_NAMESPACE} \
...
1. Example:
    ...
    helm delete --namespace ${DEMO_NAMESPACE} ${DEMO_PREFIX}-coleifer-sqlite-web
    helm delete --namespace ${DEMO_NAMESPACE} ${DEMO_PREFIX}-coleifer-sqlite-web-libfeat
    helm delete --namespace ${DEMO_NAMESPACE} ${DEMO_PREFIX}-coleifer-sqlite-web-res
